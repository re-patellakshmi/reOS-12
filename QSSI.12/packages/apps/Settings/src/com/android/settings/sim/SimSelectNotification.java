...
public class SimSelectNotification extends BroadcastReceiver {
        ...
        private void alertNoSIM(Context context) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(context).setTitle(R.string.no_sim_card)
        ...
        private void onEnableMmsDataRequest(Context context, Intent intent) {
                ...
                // Getting request reason from extra, which will determine the notification
                // title.
        ...
        private void sendSimCombinationWarningIfNeeded(Context context, Intent intent) {
                ...
                if (warningType == EXTRA_SIM_COMBINATION_WARNING_TYPE_DUAL_CDMA) {
                        // Create a notification to tell the user that there's a sim combination
                        // warning.
        ...
        private void createSimSelectNotification(Context context) {
                ...
                Notification.Builder builder = new Notification.Builder(context, SIM_SELECT_NOTIFICATION_CHANNEL)
        ...
        private void createEnableMmsNotification(Context context, CharSequence titleString,
                ...
                Notification.Builder builder = new Notification.Builder(context, ENABLE_MMS_NOTIFICATION_CHANNEL)
        ...
        private void createSimCombinationWarningNotification(Context context, Intent intent) {
                ...
                Notification.Builder builder = new Notification.Builder(context, SIM_WARNING_NOTIFICATION_CHANNEL)
                                .setSmallIcon(R.drawable.ic_sim_alert)
                                .setColor(context.getColor(R.color.sim_noitification))
