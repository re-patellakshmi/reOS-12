...
public class ServiceStateTracker extends Handler {
    ...
    protected static final int EVENT_SET_NET_MODE_GLOBAL               = 63;
    protected static final int EVENT_SET_ALERT_NET_GLOBAL              = 64;
    ...
    private void notifySpnDisplayUpdate(CarrierDisplayNameData data) {
        ...
        if (combinedRegState == ServiceState.STATE_OUT_OF_SERVICE
            ...
            if(netMode!=TelephonyManager.NETWORK_MODE_LTE_CDMA_EVDO_GSM_WCDMA && !mIsNetAlertGoingToShow){
    ...
    private void updateSpnDisplayLegacy() {
        ...
        if (mPhone.isPhoneTypeGsm()) {
            ...
            if (SystemProperties.getBoolean("persist.certification.mode", false)
                    && ("310410".equals(mccmnc) || "313100".equals(mccmnc))) {
                log("change rule to SPN_RULE_SHOW_PLMN for ATT : mccmnc=" + mccmnc);
    ...
    private ContentObserver mPreferedNetworkModeObserver = new ContentObserver(new Handler()) {
        ...
        public void onChange(boolean selfChange) {
            ...
            log("Preferred nw mode change : new mode=" + netMode + ", regState=" + getCombinedRegState(mSS) + ", mIsNetAlertGoingToShow=" + mIsNetAlertGoingToShow);
            if(netMode!=TelephonyManager.NETWORK_MODE_LTE_CDMA_EVDO_GSM_WCDMA && getCombinedRegState(mSS) == ServiceState.STATE_OUT_OF_SERVICE){
    ...
    private  void alertChangeNetMode(){
        int netMode = Settings.Global.getInt(mPhone.getContext().getContentResolver(),
                        android.provider.Settings.Global.PREFERRED_NETWORK_MODE + mPhone.getSubId(),10);
        if(netMode==TelephonyManager.NETWORK_MODE_LTE_CDMA_EVDO_GSM_WCDMA){
            mIsNetAlertGoingToShow = false;
            ...
            AlertDialog.Builder builder = new AlertDialog
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mIsNetAlertGoingToShow = false;
                        mPhone.setPreferredNetworkType(TelephonyManager.NETWORK_MODE_LTE_CDMA_EVDO_GSM_WCDMA,
