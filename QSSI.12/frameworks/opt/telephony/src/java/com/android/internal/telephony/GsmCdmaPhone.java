...
public class GsmCdmaPhone extends Phone {
   ...
   @Override
    ...
    private void updateBasebandInfoByPersist(){
        String baseband_str = "Unknown";
        try {
            baseband_str = SystemProperties.get("persist.version.baseband");
            int radioState = mCi.getRadioState();
            if (radioState == TelephonyManager.RADIO_POWER_UNAVAILABLE) {
                if("Unknown".equals(SystemProperties.get("gsm.version.baseband","Unknown"))){
                    SystemProperties.set("gsm.version.baseband",baseband_str);
                }
            }
