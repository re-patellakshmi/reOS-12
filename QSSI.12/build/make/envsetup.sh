...
VARIANT_CHOICES=(user userdebug eng wifionlyuser wifionlyuserdebug)
...
function choosevariant()
{
    ...
    export TARGET_QUECTEL_WIFIONLY_BUILD=
...
function lunch()
{
    ...
    TARGET_QUECTEL_WIFIONLY_BUILD=$variant \
    build_build_var_cache
    if [ $? -ne 0 ]
    then
        return 1
    ...
    export TARGET_BUILD_TYPE=release
    export TARGET_QUECTEL_WIFIONLY_BUILD=$variant
