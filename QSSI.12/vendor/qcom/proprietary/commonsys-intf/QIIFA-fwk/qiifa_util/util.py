...
class Constants:
    ...
    supported_platform_version = {"R" : 11 , "S" : 12}
    ...
    aidl_skipped_intf = UtilFunctions.validValue("",qc_path,"/commonsys-intf/QIIFA-cmd/hidl/qiifa_aidl_skipped_interfaces.txt")
    aidl_skipped_intf_lst = ['vendor.qti.hardware.radio.ims',
    ...
    AIDL_SUPPORTED_CREATE_ARGS = ["aidl","aidl_one","aidl_new"]
