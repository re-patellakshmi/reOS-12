...
QCRIL_DATA_HAL += vendor.qti.hardware.data.connectionfactory-V1-ndk_platform
QCRIL_DATA_HAL += vendor.qti.hardware.data.connectionfactory-V1-java
QCRIL_DATA_HAL += vendor.qti.hardware.data.dataactivity-V1-ndk_platform
QCRIL_DATA_HAL += vendor.qti.hardware.data.dataactivity-V1-java
QCRIL_DATA_HAL += vendor.qti.hardware.data.ka-V1-ndk_platform
