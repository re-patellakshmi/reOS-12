...
// -----------------------------------------------------------------------
     ...
     *        <br> STATUS_EFAILURE
     */
    public static native int getSMLVersion(SMLVersion version);
...
@Deprecated
     ...
     *        <br>   STATUS_EFAILURE
     */
     public static native int verifyUserRecordingQuality(
            ByteBuffer       soundModel,
            String           keywordPhrase,
            ShortBuffer      userRecording,
     ...
     *        <br>   STATUS_EFAILURE
     */
     public static native int SetSoundModelTuningParams(
         int keywordType,
