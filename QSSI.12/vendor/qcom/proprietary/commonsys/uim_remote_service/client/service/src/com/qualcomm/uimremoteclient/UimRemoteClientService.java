...
public class UimRemoteClientService extends Service {
    ...
    private class RadioStateListener extends TelephonyCallback
        ...
        public void onRadioPowerStateChanged(int state) {
            Log.i(LOG_TAG, "state: " + state + "slot: ");
            Message msg = mRadioStateHdlr.obtainMessage(state, 0);
            msg.sendToTarget();
        }
    }
    ...
    public void onCreate() {
        ...
        for(int i = 0; i < simSlots; i++) {
            ...
            tm[i].registerTelephonyCallback(context.getMainExecutor(), rl[i]);
    ...
    public void onDestroy() {
        ...
        for(int i = 0; i < simSlots; i++) {
            tm[i].unregisterTelephonyCallback(rl[i]);
