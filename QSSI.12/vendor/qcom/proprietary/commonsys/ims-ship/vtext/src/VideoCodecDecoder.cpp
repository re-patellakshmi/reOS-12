...
#define MEDIA_KEY_COLORSPACE_CONSISTENT (char*)"vendor.qti-ext-dec-vt-colorspace-consistent.value\0"
...
QPE_VIDEO_ERROR VideoCodecDecoder::Configure(QP_VIDEO_CONFIG tCodecConfig)
{
  ...
  //Codec2 would always use original color aspect for IMS-VT use case.
  AMediaFormat_setInt32(m_format, MEDIA_KEY_COLORSPACE_CONSISTENT, 1 );
