...
public class RCSServiceStub extends UceServiceBase { //extend AIDL- IUCEService
    ...
    public boolean updateDefaultIccId(int defaultSubId) {
        ...
        if (defaultSubInfo != null) {
            synchronized (mIccId) {
                ...
                Log.i(logTAG, "getDefaultIccId default mIccId [" + mIccId +"] mDefaultSlotId [" +mDefaultSlotIdx+"] defaultSubId [" +defaultSubId+"]");
            }
            retval = true;
        }
    ...
    protected int onCreateOptionsService(IOptionsListener optionsListener,
        ...
        synchronized (mIccId) {
           defaultIccId = mIccId;
           Log.i(logTAG, "onCreateOptionsService legacy API hit [" + defaultIccId +"]");
        }
    ...
    protected int onCreatePresService(
        ...
        synchronized (mIccId) {
            defaultIccId = mIccId;
            Log.i(logTAG, "onCreatePresService legacy API hit [" + defaultIccId +"]");
        }
    ...
    protected IOptionsService onGetOptionsService() {
        ...
        /* Its possible that after retrieving IccId DDS change happens.
           ...
           used */
        synchronized (mIccId) {
            Log.i(logTAG, "onGetOptionsService default mIccId [" + mIccId +"]");
