...
public class ImsUtImpl extends ImsUtImplBase {
    ...
    void setOnClosedListener(IOnCloseListener l) {
        synchronized(mLock) {
            mOnCloseListener = l;
        }
    }
    ...
    public void close() {
        ...
        IOnCloseListener onCloseListener = null;
        synchronized(mLock) {
            mIsDisposed = true;
            if (mCi != null) {
    ...
    public boolean queryCallBarringForServiceClass(int cbType, int serviceClass,
        ...
        enforceReadPhoneState("queryCallBarring");
        ImsSenderRxr ci = null;
        synchronized(mLock) {
            ci = mCi;
            if (isDisposed() || ci == null) {
        ...
        if (facility == SuppSvcResponse.FACILITY_BS_MT) {
            ci.suppSvcStatus(SuppSvcResponse.QUERY,
                    facility,
                    null,
                    password,
                    SERVICE_CLASS_VOICE,
    ...
    public int queryCFForServiceClass(int condition, String number, int serviceClass) {
        ...
        ci.queryCallForwardStatus(reason,
                                   serviceClass,
                                   number,
    ...
    public int queryCallWaiting() {
        ...
        ci.queryCallWaiting(SERVICE_CLASS_NONE,
    ...
    public int queryClir() {
        ...
        ci.getCLIR(mHandler.obtainMessage(EVENT_QUERY_CLIR, id, 0, this));
        return id;
    }
    ...
    public int queryClip() {
        ...
        ci.queryCLIP(mHandler.obtainMessage(EVENT_QUERY_CLIP, id, 0, this));
        return id;
    }
    ...
    public int queryColr() {
        ...
        ci.getCOLR(mHandler.obtainMessage(EVENT_QUERY_COLR, id, 0, this));
        return id;
    }
    ...
    public int queryColp() {
        ...
        ci.getSuppSvc("COLP", //TODO: String argument required. Use like this or define somewhere?
    ...
    public int updateCallForwardUncondTimer(int startHour, int startMinute, int endHour,
        ...
        ci.setCallForwardUncondTimer(startHour, startMinute, endHour, endMinute,
                           action, condition,
    ...
    */
    ...
    // This should be called in a synchronized block to assure thread safety
    ...
    private class ImsUtImplHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            ImsUtListenerImpl listener = null;
            synchronized(mLock) {
                listener = mListenerImpl;
                ...
                case EVENT_QUERY_CB:
                    ...
                    if (ar != null) {
                        ...
                        if (ar.exception != null) {
                            ...
                            if (ar.userObj != null) {
                                listener.utConfigurationQueryFailed(msg.arg1,
                            ...
                            if (sipError != null) {
                                ...
                                listener.utConfigurationQueryFailed(msg.arg1, error);
                                return;
                            }
                            if (response.getStatus() == SuppSvcResponse.INVALID) {
                                ...
                                if(!response.getBarredLines().isEmpty()) {
                                    ...
                                    listener.utConfigurationCallBarringQueried(
                                    ...
                                    Log.i(this, "success callback Query Anonymous CB, status= "
                                            + ssInfo.getStatus());
                                    listener.utConfigurationCallBarringQueried(msg.arg1,
                                            ssInfoStatus);
                                }
                            }
                        }
                            ...
                            listener.utConfigurationQueryFailed(msg.arg1, new ImsReasonInfo(
                ...
                case EVENT_UPDATE_CB:
                    ...
                    if (ar != null) {
                        ...
                        if (ar.exception != null) {
                            ...
                            if (ar.userObj != null) {
                                listener.utConfigurationUpdateFailed(msg.arg1,
                                        getImsReasonInfoFromResponseError(ar));
                            }
                        }
                        else if (ar.result != null) {
                            ...
                            listener.utConfigurationUpdated(msg.arg1);
                        }
                        else {
                    ...
                    if (ar != null) {
                        ...
                        if (ar.exception != null) {
                            ...
                            if (callForwardInfoList == null) {
                                listener.utConfigurationQueryFailed(
                            ...
                            listener.utConfigurationCallForwardQueried(
                                    msg.arg1,
                                    callForwardInfoList);
                        }
                        else {
                ...
                case EVENT_QUERY_CW:
                    ...
                    if (ar != null) {
                        ...
                        if (ar.exception != null) {
                            ...
                            listener.utConfigurationCallWaitingQueried(
                                    msg.arg1,
                                    callWaitingInfoList);
                        }
                        else {
                    ...
                    if (ar != null) {
                        ...
                        if (ar.exception != null) {
                            ...
                            if (clirResp != null && clirResp.length ==
                                ...
                                listener.lineIdentificationSupplementaryServiceResponse(
                                        msg.arg1, info);
                            } else {
                ...
                case EVENT_UPDATE_COLP:
                        ...
                        if (ar.exception != null) {
                            ...
                            if (ar.result != null) {
                                ...
                                if (sipError != null) {
                                    ...
                                    listener.utConfigurationUpdateFailed(
                                            msg.arg1,
                                            new ImsReasonInfo(ImsReasonInfo.CODE_UT_NETWORK_ERROR,
                                            sipError.getExtraCode(), sipError.getExtraMessage()));
                 ...
                 case EVENT_UNSOL_ON_SS:
                    ...
                    if (ar.exception == null) {
                        ...
                        listener.onSupplementaryServiceIndication(ssData);
                    } else {
