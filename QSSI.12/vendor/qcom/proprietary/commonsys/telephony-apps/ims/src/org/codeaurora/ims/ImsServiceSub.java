...
public class ImsServiceSub extends MmTelFeature
    ...
    public void onRegistered(int registrationState, ImsReasonInfo info,
        ...
        if (mFeatureCallbackHandler != null) {
            mFeatureCallbackHandler.post(
                    () -> mImsReg.registeredWithRadioTech(imsRat));
        }
    }
    ...
    public void onRegistering(int registrationState, ImsReasonInfo info,
        ...
        if (mFeatureCallbackHandler != null) {
            mFeatureCallbackHandler.post(
                    () -> mImsReg.registeringWithRadioTech(imsRat));
        }
    }
        ...
        if (mFeatureCallbackHandler != null) {
            mFeatureCallbackHandler.post(
                    () -> mImsReg.registrationChangeFailed(
                           ImsRegistrationUtils.toTelephonManagerRadioTech(imsRadioTech), info));
        }
    }
    ...
    private void deregisterForImsEvents() {
        mCi.deregisterForPreAlertingCallInfo(mHandler);
    ...
    public ImsUtImpl getUt() {
        ...
        synchronized(mLock) {
            ...
            utImpl = mImsUtImpl = new ImsUtImpl(this, mCi, mContext);
        }
        utImpl.setOnClosedListener(this);
        return utImpl;
    }
    ...
    private void onGetCallBarringReqDone(IQtiImsExtListener listener, AsyncResult ar) {
        try {
            ...
            logi( "onGetCallBarringReqDone successful response! ");
    ...
    */
    ...
    public void onClosed(ImsUtImpl obj) {
        ...
        if (utImpl != null) {
            utImpl.setOnClosedListener(null);
        }
    }
