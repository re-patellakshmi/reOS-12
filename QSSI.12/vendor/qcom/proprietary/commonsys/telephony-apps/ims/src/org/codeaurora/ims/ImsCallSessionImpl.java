...
public class ImsCallSessionImpl extends QImsSessionBase
        ...
        switch (dcUpdate.state) {
            ...
            case DIALING:
                if (mDc == null) { // No DC yet for pending MO
                    ...
                    mCallId = dcUpdate.index;
                    if (mStateChangeReportingAllowed) {
                        mCallbackHandler.callSessionInitiating(mCallProfile.newImsCallProfile());
                    }
                }
    ...
    public static ImsStreamMediaProfile updateMediaProfileAudioDirection(
            QImsCallProfile callProfile, boolean isLocalRingback) {
        if (callProfile == null) {
            return null;
        }
        ...
        callProfile.updateMediaProfile(newMediaProfile);
    ...
    private void updateImsCallProfile(DriverCallIms dc) {
        ...
        int prevCallMode = getCallMode(mDc);
        ...
        if (dc.callDetails != null && dc.callDetails.localAbility != null) {
            ...
            if (prevCallMode == RadioTech.RADIO_TECH_C_IWLAN && callMode != prevCallMode) {
                mCallProfile.setCallExtraBoolean(ImsCallProfile.EXTRA_IS_CROSS_SIM_CALL, false);
            } else if (callMode == RadioTech.RADIO_TECH_C_IWLAN && callMode != prevCallMode) {
                mCallProfile.setCallExtraBoolean(ImsCallProfile.EXTRA_IS_CROSS_SIM_CALL, true);
            }
        ...
        // Update Rtt attribute from CallDetails
        mediaProfile.setRttMode(dc.callDetails.rttMode);
        mCallProfile.updateMediaProfile(mediaProfile);
