    ...
    public boolean handleMessage(Message msg) {
        ...
        switch (msgID) {
            ...
            case MSG_REQUEST_ADDR:
            {
                ...
                Runnable getAddrFromLocation = new Runnable() {
                    @Override
                    public void run() {
                        try {
                            List<Address> addrList = mGeocoder
                            ...
                            if (addrList != null && addrList.size() != 0 && mIdlClient != null) {
                                ...
                                mIdlClient.injectLocationAndAddr(loc, addr);
                            }
                ...
                mIZatServiceCtx.executeRunnable(getAddrFromLocation);
                break;
            }
        }
        return true;
