/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
*  Copyright (c) 2012-2014, 2020-2021 Qualcomm Technologies, Inc.
*  All Rights Reserved.
...
public class RilInfoMonitor implements IzatService.ISystemEventListener, Handler.Callback {
    ...
    private RilInfoMonitorIdlClient mRemoteServiceClient;
    ...
    public RilInfoMonitor(Context context, int config) {
        ...
        if (LocIDLClientBase.getIDLServiceVersion().compareTo(IDLServiceVersion.V_AIDL) >= 0) {
            mRemoteServiceClient = new RilInfoMonitorIdlClient();
        } else {
     ...
     *   HIDL Client
     * =================================================*/
    public class RilInfoMonitorHidlClient extends RilInfoMonitorIdlClient
     ...
     *   AIDL Client
     * =================================================*/
    public class RilInfoMonitorIdlClient extends LocIDLClientBase
            implements LocIDLClientBase.IServiceDeathCb {
        private final String TAG = "RilInfoMonitorAidlClient";
        private static final int GPS_SV_TYPE = 1;
        private static final int GALILEO_SV_TYPE = 6;
        private ILocAidlRilInfoMonitor mRilInfoMonitor;

        private ILocAidlRilInfoMonitor getRilInfoMonitorIface() {
            if (null == mRilInfoMonitor) {
                ...
                try {
                    mRilInfoMonitor = service.getExtensionLocAidlRilInfoMonitor();
                    if (null == mRilInfoMonitor) {
                        Log.e(TAG, "ILocAidlRilInfoMonitor handle is null");
                        return null;
                    }
                    Log.d(TAG, "getRilInfoMonitorIface, mRilInfoMonitor=" +
                            mRilInfoMonitor);
        ...
        private RilInfoMonitorIdlClient() {
            getRilInfoMonitorIface();
            if (null != mRilInfoMonitor) {
                try {
                    mRilInfoMonitor.init();
                    registerServiceDiedCb(this);
                    Log.d(TAG, "RilInfoMonitorAidlClient aidl init");
                } catch (RemoteException e) {
                    Log.e(TAG, "Exception init RilInfoMonitor: " + e);
                }
            }
        ...
        @Override
        public void onServiceDied() {
            Log.e(TAG, "ILocAidlRilInfoMonitor died");
            mRilInfoMonitor = null;
            init();
        }
        ...
        public void init() {
            ...
            if (null != mRilInfoMonitor) {
                try {
                    ILocAidlRilInfoMonitor rilInfoMonitorIface = getRilInfoMonitorIface();
                    rilInfoMonitorIface.init();
                } catch (RemoteException e) {
                    Log.e(TAG, "Exception ILocAidlRilInfoMonitor::init(): " + e);
                }
            }
        }
        ...
        public void oosInform() {
            ...
            if (null != mRilInfoMonitor) {
                try {
                    ...
                    Log.e(TAG, "Exception ILocAidlRilInfoMonitor::oosInform(): " + e);
                }
            }
        }
        ...
        public void niSuplInit(byte[] data, int length) {
            ...
            if (null != mRilInfoMonitor) {
                try {
                    ...
                    Log.e(TAG, "Exception ILocAidlRilInfoMonitor::niSuplInit(): " + e);
                }
            }
        }
        ...
        public void chargerStatusInject(int status) {
            ...
            if (null != mRilInfoMonitor) {
                try {
                    ...
                    Log.e(TAG, "Exception ILocAidlRilInfoMonitor::chargerStatusInject(): " + e);
                }
            }
        }
    }
