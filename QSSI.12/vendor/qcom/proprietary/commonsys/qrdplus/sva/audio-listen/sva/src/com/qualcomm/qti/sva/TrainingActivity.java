...
public class TrainingActivity extends Activity {
    ...
    private void setSMLParameters() {
        if (isUdk()) {
            SMLParametersManager.getInstance().setSMLUDKParameters();
        } else {
    ...
    private void updateRecordingTimes() {
        if (isUdk()) {
            ...
            mRecordingTimes =  SMLParametersManager.getInstance().
                    getRecordingTimes(mRecodingType);
        }
    }
    ...
    private void startRecording() {
        ...
        mRecordingMgr.setAudioDataUpdatedListener(volume -> {
    ...
    private ISmModel.ModelVersion getUdkVersion() {
        ...
        } else if(getString(R.string.create_your_own_6_0).equals(mPreviousSmName)){
