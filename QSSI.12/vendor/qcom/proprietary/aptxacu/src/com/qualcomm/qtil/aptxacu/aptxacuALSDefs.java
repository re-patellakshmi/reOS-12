...
public class aptxacuALSDefs {
  ...
  // Message name to ALS to give it the APTX_AND_APTX_HD_PRIORITY preference value when changed
  public static final String ACTION_ACU_APTX_AND_APTX_HD_PRIORITY = "ACTION_ACU_APTX_AND_APTX_HD_PRIORITY";
  // Message name to ALS to give it the APTX_ADAPTIVE_96KHZ_SAMPLE_RATE preference value when changed
  public static final String ACTION_ACU_APTX_ADAPTIVE_96KHZ_SAMPLE_RATE = "ACTION_ACU_APTX_ADAPTIVE_96KHZ_SAMPLE_RATE";
  // Message name to ALS to give it the AUDIO_PROFILE_OVERRIDE preference value when changed
  public static final String ACTION_ACU_AUDIO_PROFILE_OVERRIDE = "ACTION_ACU_AUDIO_PROFILE_OVERRIDE";
  // Message name to ALS to give it the APP_AUDIO_PROFILE_PREFERENCE_LIST preference value when changed
  public static final String ACTION_ACU_APP_AUDIO_PROFILE_PREFERENCE_LIST = "ACTION_ACU_APP_AUDIO_PROFILE_PREFERENCE_LIST";
  ...
  public static final String APP_AUDIO_PROFILE_PREFERENCE_LIST = "app_audio_profile_preference_list";
