...
public class aptxacuSettingsFragment extends PreferenceFragmentCompat
  ...
  public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
    ...
    PreferenceCategory pref_cat_aptx_and_aptx_hd = (PreferenceCategory) findPreference(PREF_CAT_APTX_AND_APTX_HD);
    ...
    String aptx_and_aptx_hd_priority_title_str = mContext.getString(R.string.aptx_and_aptx_hd_priority_title);
    ...
    PreferenceCategory pref_cat_aptx_adaptive = (PreferenceCategory) findPreference(PREF_CAT_APTX_ADAPTIVE);
    ...
    String aptx_adaptive_96khz_sample_rate_title_str = mContext.getString(R.string.aptx_adaptive_96khz_sample_rate_title);
    ...
    // Codec audio profile
    PreferenceCategory pref_cat_codec_audio_profile = (PreferenceCategory) findPreference(PREF_CAT_CODEC_AUDIO_PROFILE);
    String pref_cat_codec_audio_profile_str = mContext.getString(R.string.pref_cat_codec_audio_profile);
    ...
    String audio_profile_override_title_str = mContext.getString(R.string.audio_profile_override_title);
    ...
    mAudioProfilePreferenceList.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
        @Override
