...
// Support ability for testing from the Android adb command line shell //
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    try {
      ...
      if (isUserUnlocked(this)) {
        ...
        String setAptxAdaptive96KHzSampleRateVal = getIntent().getExtras().getString(setAptxAdaptive96KHzSampleRateKey);
        String ON = "ON";
        String OFF = "OFF";

        if (!TextUtils.isEmpty(setAptxAdaptive96KHzSampleRateVal)) {
          if (setAptxAdaptive96KHzSampleRateVal.compareToIgnoreCase(ON) == 0) {
            Log.i(TAG, "setting SetAptxAdaptive96KHzSampleRate : " + setAptxAdaptive96KHzSampleRateVal);
            ...
            Log.e(TAG, "invalid SetAptxAdaptive96KHzSampleRate value : " + setAptxAdaptive96KHzSampleRateVal);
          }
        ...
        String setAptxAndAptxHdPriorityVal = getIntent().getExtras().getString(setAptxAndAptxHdPriorityKey);
        ...
        if (!TextUtils.isEmpty(setAptxAndAptxHdPriorityVal)) {
          if (setAptxAndAptxHdPriorityVal.compareToIgnoreCase(DEFAULT) == 0) {
            Log.i(TAG, "setting SetAptxAndAptxHdPriority : " + setAptxAndAptxHdPriorityVal);
            ...
            Log.e(TAG, "invalid SetAptxAndAptxHdPriority value : " + setAptxAndAptxHdPriorityVal);
          }
        ...
        String setAudioProfileOverrideVal = getIntent().getExtras().getString(setAudioProfileOverrideKey);
        ...
        if (!TextUtils.isEmpty(setAudioProfileOverrideVal)) {
          if (setAudioProfileOverrideVal.compareToIgnoreCase(AUTO_ADJUST) == 0) {
            Log.i(TAG, "setting SetAudioProfileOverride : " + setAudioProfileOverrideVal);
            ...
            Log.e(TAG, "invalid SetAudioProfileOverride value : " + setAudioProfileOverrideVal);
          }
