...
ifeq ($(filter $(TARGET_BOARD_PLATFORM), msm8996 msm8998 sdm845 msmnile kona taro),$(TARGET_BOARD_PLATFORM))
...
ADSPRPC += adsprpcd
ifneq ($(filter $(TARGET_BOARD_PLATFORM), msm8953 msm8937),$(TARGET_BOARD_PLATFORM))
...
SECUREMSM += android.hardware.keymaster@3.0.vendor
SECUREMSM += android.hardware.keymaster@4.0.vendor
SECUREMSM += android.hardware.keymaster@4.1.vendor
SECUREMSM += android.hardware.gatekeeper@1.0.vendor
...
ifeq ($(TARGET_BOARD_AUTO),true)
ifneq ($(DISABLE_DEFAULT_VEHICLE_NETWORKS),true)
