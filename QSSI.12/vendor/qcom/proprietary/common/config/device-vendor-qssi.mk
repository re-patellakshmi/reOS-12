...
ifeq ($(filter $(TARGET_BOARD_PLATFORM), qssi taro lahaina holi),$(TARGET_BOARD_PLATFORM))
ENABLE_INTEGER_OVERFLOW := true
ENABLE_BOUND_SANITIZER := true
endif

ifeq ($(filter $(TARGET_BOARD_PLATFORM), qssi taro),$(TARGET_BOARD_PLATFORM))
ENABLE_MEMTAG_HEAP := true
endif

ifeq ($(filter $(TARGET_BOARD_PLATFORM), qssi taro kona lito bengal lahaina holi),$(TARGET_BOARD_PLATFORM))
