...
TARGET_BOOTLOADER_BOARD_NAME := qssi_32
...
VENDOR_QTI_PLATFORM := qssi_32
VENDOR_QTI_DEVICE := qssi_32
...
$(call inherit-product, device/qcom/qssi_32/common.mk)
...
TARGET_SYSTEM_PROP += device/qcom/qssi_32/system.prop
...
DEVICE_FRAMEWORK_MANIFEST_FILE := device/qcom/qssi_32/framework_manifest.xml
...
PRODUCT_COPY_FILES += \
    device/qcom/qssi_32/init.qcom.testscripts.sh:$(TARGET_COPY_OUT_PRODUCT)/etc/init.qcom.testscripts.sh
endif

PRODUCT_COPY_FILES += \
    device/qcom/qssi_32/public.libraries.product-qti.txt:$(TARGET_COPY_OUT_PRODUCT)/etc/public.libraries-qti.txt
...
DEVICE_PACKAGE_OVERLAYS += device/qcom/qssi_32/overlay
endif
...
ifeq (true,$(call math_gt_or_eq,$(SHIPPING_API_LEVEL),29))
  $(call inherit-product, device/qcom/qssi_32/qssi_whitelist.mk)
